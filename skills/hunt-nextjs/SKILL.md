---
name: hunt-nextjs
description: Next.js attacks — Server Actions RCE, middleware auth bypass, Image Optimization SSRF, RSC and source-map leakage. Use when the target runs Next.js 13/14/15.
...
grep -r "createActionURL\|$$ACTION_" $OUTPUT_DIR/recon/ --include="*.js" 2>/dev/null
