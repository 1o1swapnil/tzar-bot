...
description: Supply-chain recon — dependency confusion, typosquatting, leaked package tokens, CI artifact poisoning, third-party SaaS trust. Use when mapping an org's software supply chain.
