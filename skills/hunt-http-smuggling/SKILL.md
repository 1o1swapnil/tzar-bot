...
description: HTTP request smuggling — CL.TE, TE.CL, H2.CL/H2.TE downgrade; cache-poisoning, auth-bypass, and credential-capture chains. Use on CDN+origin or load-balanced stacks.
---
