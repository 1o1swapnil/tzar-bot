---
name: okta-attack
description: Okta IdP attacks — SSO bypass, factor enumeration, session hijack, admin-API abuse, social-engineering MFA reset. Use when the target uses Okta as identity provider.
