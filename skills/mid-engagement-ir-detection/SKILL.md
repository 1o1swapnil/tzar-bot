...
description: Detect blue-team / IR response mid-engagement — SOC-patch detection, behavior-change-as-finding, baseline drift. Use during an active red team to capture defensive-action findings.
