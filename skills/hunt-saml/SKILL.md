---
name: hunt-saml
description: SAML / SSO attacks — XML Signature Wrapping (XSW), comment injection, signature stripping, key confusion, assertion replay. Use on /saml, /sso, and ADFS endpoints.
---
...
```bash
# Find SAML endpoints
cat $OUTPUT_DIR/recon/urls.txt | grep -iE "saml|sso|login.*redirect|oauth|idp|sp"
