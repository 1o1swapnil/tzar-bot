...
description: Host header injection — password-reset poisoning to ATO, cache poisoning, routing-based SSRF, OAuth redirect_uri poisoning. Use on forgot-password flows and reverse-proxy-fronted apps.
