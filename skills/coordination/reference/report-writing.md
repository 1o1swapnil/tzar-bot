...
- **`bb-methodology`** — When Phase 5's report-writing step starts. Workflow primitive: Phase 5 runs `generate-report.py`, which uses this skill for the platform-specific template (H1 / Bugcrowd / Intigriti / Immunefi).
