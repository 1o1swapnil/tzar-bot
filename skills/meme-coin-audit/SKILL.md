...
description: Meme-coin / token rug-pull audit — honeypot checks, mint/owner privileges, liquidity locks, transfer-tax traps. Use when auditing a meme or ERC-20 token contract.
---
