...
description: Insecure deserialization RCE — Java (ysoserial), PHP (phpggc), Python pickle, .NET, Ruby Marshal, JNDI/Log4Shell. Use when the target deserializes untrusted data.
