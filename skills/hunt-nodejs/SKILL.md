---
name: hunt-nodejs
description: Node.js attacks — prototype pollution to RCE, SSTI (EJS/Pug/Handlebars), child_process/eval injection, trust-proxy misconfig. Use when the target runs Node/Express/Nest/Koa.
