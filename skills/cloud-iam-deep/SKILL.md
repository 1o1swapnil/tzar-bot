---
name: cloud-iam-deep
description: Cloud IAM privilege escalation after a credential surfaces — AWS/Azure/GCP keys, STS AssumeRole chaining, managed-identity abuse, Cognito, K8s SA tokens, confused-deputy. Use when a cloud credential is recovered.
