...
description: SSL-VPN / remote-access appliance attacks — Cisco ASA, Fortinet, Citrix NetScaler, Palo Alto GlobalProtect, Pulse/Ivanti, SonicWall, F5; version fingerprint + CVE matrix. Use when a VPN gateway is on the perimeter.
