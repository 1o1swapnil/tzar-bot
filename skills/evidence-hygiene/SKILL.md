...
description: PoC evidence hygiene — cookie/PII redaction, HAR sanitization, screenshot discipline. Use before attaching any PoC containing session cookies or other-user data.
---
