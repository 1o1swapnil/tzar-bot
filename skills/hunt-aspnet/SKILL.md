---
name: hunt-aspnet
description: ASP.NET attacks — ViewState deserialization, machineKey recovery, request-validator bypass, trace.axd/elmah leakage. Use when the target runs ASP.NET Webforms / WCF.
