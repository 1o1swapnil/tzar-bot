---
name: hunt-nosqli
description: NoSQL injection — MongoDB operator injection ($ne/$gt), auth bypass, server-side JS injection, blind extraction. Use on Mongo/Couch/Redis-backed apps.
