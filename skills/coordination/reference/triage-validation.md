...
- **`bb-methodology`** — When Phase 5 (Validate & Report) starts. Workflow primitive: Phase 5's pre-report gate explicitly runs `validate-finding.py` (this skill's 7Q gate) before any report is drafted.
