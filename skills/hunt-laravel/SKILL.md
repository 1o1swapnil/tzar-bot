---
name: hunt-laravel
description: Laravel attacks — APP_DEBUG leakage, Telescope/Horizon exposure, Ignition RCE (CVE-2021-3129), signed-URL tampering, .env exposure. Use when the target runs Laravel.
...
cat $OUTPUT_DIR/recon/urls.txt | grep "signature="
