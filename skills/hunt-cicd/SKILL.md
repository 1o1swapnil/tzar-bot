---
name: hunt-cicd
description: CI/CD pipeline attacks — GitHub Actions injection (pull_request_target), self-hosted runner poisoning, OIDC trust abuse, Jenkins RCE, secret/artifact leakage. Use on public GitHub/GitLab orgs or exposed CI dashboards.
