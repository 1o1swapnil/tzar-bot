...
description: Bug-bounty toolkit — recon, vuln hunting (IDOR/SSRF/XSS/auth/SQLi/SSTI/etc.), LLM/AI testing, bug chaining, reporting. Use for general bug-bounty work. 中文：漏洞赏金、信息收集、漏洞挖掘、安全测试。
---
