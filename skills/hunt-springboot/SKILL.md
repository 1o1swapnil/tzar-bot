...
description: Spring Boot attacks — exposed Actuator endpoints, SpEL injection, Spring4Shell, H2-console RCE, env/heapdump leakage. Use when the target runs Spring Boot.
